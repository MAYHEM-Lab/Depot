...
export const SetupCommands = (commands, palette, nbWidget) => {
    commands.addCommand(cmdIds.invokeNotebook, {
        label: 'Invoke Notebook',
        execute: () => {
            if (nbWidget.content.activeCell && nbWidget.content.activeCell.model.type === 'code') {
    ...
    commands.addCommand(cmdIds.interrupt, {
        label: 'Interrupt',
        execute: async () => {
            const session = nbWidget.context.sessionContext.session
